...
import com.pisarenko.providesupport.model.ResponseTime;
...
public class WebsiteServiceTest {
    ...
    public void setUp() {
        website = Website.builder()
                .id("1").url("https://telegram.org/").responseTime(ResponseTime.OK).responseCode("200")
                .minResponseValue((byte) 1).maxResponseValue((byte) 125)
                .build();
    }
